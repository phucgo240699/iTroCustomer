...
extension  UIViewController{
    ...
    func ShowMessage(_ title: String, _ description: String){
        SwiftEntryKit.display(entry: MyPopUpView(with: setupMessage(title, description)), using: setupAttributes())
    }
    ...
    func setupMessage(_ title: String, _ description: String) -> EKPopUpMessage {
